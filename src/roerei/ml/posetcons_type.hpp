...
inline std::string to_string(posetcons_type t)
{
	switch(t)
	{
...
inline std::ostream& operator<<(std::ostream& os, posetcons_type t)
{
	return os << to_string(t);
}

inline posetcons_type to_posetcons_type(std::string const& str)
{
